...
#walkdir = "./../../data/irc/"
#input filepath like "pythondev/2018"
walkdir = input("Enter filepath: ")
    ...
    for root, dirnames, filenames in os.walk(walkdir):
        for filename in filenames:
            if not filename.endswith('.xml'):
                ...
                outfile = input("Enter output csv file name: " ) #include .csv extension

                with open(outfile, 'w', encoding='utf-8-sig') as fpointer:
